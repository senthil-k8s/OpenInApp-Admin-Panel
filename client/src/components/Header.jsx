...
const Header = () => {
  ...
  return (
    <div>
      <div className="fixed w-full flex items-center justify-between h-14 text-white z-10  bg-white pb-10 pt-10">
        <div className="flex items-center justify-start md:justify-center mt-4 pl-3 w-14 md:w-64 h-14  border-none">
          <a href="/" className="flex items-center gap-3">
            <img src={Logo} alt="" />
            <h1 className="text-black font-nunito w-14 h-8 text-3xl">Base</h1>
          </a>
        </div>
        <div className="flex w-full justify-between items-center mt-6">
          <div className="w-full md:block hidden">
            {location.pathname === "/upload" && (
              <h1 className=" font-nunito text-black text-title-md justify-start">
                Upload CSV
              </h1>
            )}
          </div>
          <div className="flex w-full justify-end items-center h-14 header-right gap-2">
            <svg
              className="w-8 h-8"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <ul className="flex items-center">
              <li>
                <a
                  href="#"
                  className="flex items-center mr-4 hover:text-black-100"
                >
                  <span className="inline-flex mr-1 p-2 rounded-full border-2">
                    <svg
                      className="w-5 h-5"
                      viewBox="0 0 20 20"
                      version="1.1"
