  ...
  return (
    <div>
      <div className="h-full ml-14 mt-24 mb-10 md:ml-64 flex flex-col justify-center items-center">
          ...
          >
            {selectedFile ? (
              ...
              <>
                <label
                  htmlFor="file-upload"
                  className="w-full flex flex-col items-center md:p-24 p-4 bg-white text-blue rounded-lg shadow-lg tracking-wide border border-dashed cursor-pointer hover:bg-blue hover:text-white"
                >
                  <img src={Excel} alt="" className="w-8 h-8" />
                  <p className="mt-2 font-nunito text-gray-400 text-lg">
                    Drop your excel File or{" "}
                    <span className="text-[#605BFF] font-nunito">browse</span>
                  </p>
                  <input
                    type="file"
                    className="hidden"
            ...
            <button
              type="submit"
              className="w-full mt-4 bg-[#605BFF]  text-white font-bold py-2 px-4 rounded"
        ...
        <div className="w-full">{data.length > 0 && <Table data={data} />}</div>
      </div>
    </div>
  );
};
