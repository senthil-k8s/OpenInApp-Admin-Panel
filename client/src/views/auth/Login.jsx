...
const Login = ({setToken}) => {
  ...
  const handleSubmit = () => {
      if(email==="admin@gmail.com" && password ==='admin123'){
        localStorage.setItem('token','sdfdsfjhdsfsdf');
        setToken('sdfdsfjhdsfsdf')
      }
  }
  return (
    <>
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <div>
              ...
              <div className="flex justify-center items-center mt-3">
                ...
                <button
                  type="button"
                  className="w-full flex bg-[#FEFFFE] justify-center items-center m-2 p-2 rounded-xl"
                >
                  <FaApple
                    className="flex justify-center items-center  w-[25px] h-[25px] mr-2"
                    style={{ color: "#999999" }}
                  />
                ...
                <div className="rounded-lg">
                  <form className="flex flex-col items-center">
                    <div className="flex flex-col relative w-full text-sm mb-5">
                      <h1 className="font-lato text-[#000000] mb-2">
                        Email address
                      </h1>
                      <input
                    ...
                    <p className="m-2 py-2 text-sm flex justify-start w-full font-semibold text-[#5E9BDB] cursor-pointer hover:text-blue-500">
                      {" "}
                      Forgot password ?{" "}
                    </p>
                    <button
                  ...
                  <div className="flex mt-5 text-center">
                    <p className="ml-12 mr-2 font-semibold text-gray-400">
                      {"Don't"} you have an account?
                    </p>
                    <p className="font-semibold text-[#5E9BDB] cursor-pointer hover:text-[#5E9BDB]-800 hover:text-blue-500 ">
                      Register here
                    </p>
                  </div>
                </div>
